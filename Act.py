...
while xc[2]>Purity:
	...
	stages+=1
	print(stages)
print(flowrates(xcp,yval2,xjp00,Ta,flowval1,Tapp,xf,0,0,pi0,ptd0).x,stages,flowval,"flowval",xjp0,"xjp0")
y00=yvalu(xcp,Tapp)
print(y00.x,"y00")
