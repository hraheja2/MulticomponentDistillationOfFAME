...
y00=yvalu(xcp,Tap)
print(y00.x,"y00")
#(vflowr+flow-xjp0)*((xjp1[0]*((0.452+(c_p[0][0]*np.log(xjp1[5]/303.0)))))+(xjp1[1])*(0.126+c_p[1][0]*np.log(xjp1[5]/303.0))+(xjp1[2])*(0.495+(c_p[2][0]*np.log(xjp1[5]/303.0)))+(xjp1[3])*(0.069+(c_p[3][0]*np.log(xjp1[5]/303.0))))-((flow)*((xb[0]*((0.452+(c_p[0][0]*np.log(Ta/303.0)))))+(xb[1])*(0.126+c_p[1][0]*np.log(Ta/303.0))+(xb[2])*(0.495+(c_p[2][0]*np.log(Ta/303.0)))+(xb[3])*(0.069+(c_p[3][0]*np.log(Ta/303.0)))))-((xjp1[4])*(yval[0][0]*((0.452+c_p[0][1]*(np.log(Ta/303.0))))+(yval[0][1]*(0.239+c_p[1][1]*np.log(Ta/303.0)))+(yval[0][2]*(0.288+c_p[2][1]*np.log(Ta/303.0)))+(yval[0][3]*(0.188+c_p[3][1]*np.log(Ta/303.0)))))+((xjp0)*(yval0[0][0]*((0.452+c_p[0][1]*(np.log(tval/303.0))))+(yval0[0][1]*(0.239+c_p[1][1]*np.log(tval/303.0)))+(yval0[0][2]*(0.288+c_p[2][1]*np.log(tval/303.0)))+(yval0[0][3]*(0.188+c_p[3][1]*np.log(tval/303.0)))